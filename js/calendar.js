...
const StudentCalendar = (() => {
  ...
  const computers = L('14:00–15:40', subjects[1], 'Практика', 'Шур Семен Юрьевич', 'Главное здание, ауд. 301А');
  const design = [L('12:00–13:40', subjects[2], 'Практика', 'Зубов Андрей Генрихович'), L('14:00–15:40', subjects[2], 'КПР', 'Зубов Андрей Генрихович', 'Главное здание, ауд. 303')];
