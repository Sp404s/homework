...
const StudentCalendar = (() => {
  ...
  const designRoom = 'Главное здание, ауд. 303';
  const design = [L('12:00–13:40', subjects[2], 'Практика', 'Зубов Андрей Гендрихович', designRoom), L('14:00–15:40', subjects[2], 'КПР', 'Зубов Андрей Гендрихович', designRoom)];
