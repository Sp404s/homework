...
Мобильный сайт с расписанием и домашними заданиями. Опубликованная версия использует Vercel Functions, Telegram webhook и Upstash Redis. Новые формулировки заданий автоматически переводятся на китайский при переключении языка; результат кэшируется на сервере.
